...
echo 'export WAR_ID=MEXICO' | sudo tee -a /etc/environment
sudo wget -O /opt/bitnami/apache-tomcat/webapps/defender.war http://awars.javier-moreno.com.s3.amazonaws.com/AWarSDefender-0.0.2-SNAPSHOT.war
